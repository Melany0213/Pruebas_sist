...
class Solicitud(models.Model):
    ...
    #Para la fecha de solicitud automatica
    def save(self, *args, **kwargs):
        self.date_has_solicitud = timezone.now().date()
        self.clean()  # Realizar validación antes de guardar
        super().save(*args, **kwargs)
...
class Jurado(models.Model):
    ...
    # Verificar que solo se elija un profesor como jefe de tribunal
        ...
        # Verificar si el tribunal tiene solo un profesor y asignar None a jefe_tribunal si es así
